...
# pre-train
CUDA_VISIBLE_DEVICES=2 python run_pretrain.py --bizdate=bert4eth_1M_min3_dup_seq100_mask80 --max_seq_length=100 --checkpointDir=bert4eth_1M_min3_dup_seq100_mask80_shared_zipfan1000 --neg_sample_num=1000 --neg_strategy=zip --neg_share=True
